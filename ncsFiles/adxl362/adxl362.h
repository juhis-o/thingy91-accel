...
#define ADXL362_STATUS_CHECK_FIFO_WATERMARK(x)	(((x) >> 2) & 0x1)
#define ADXL362_STATUS_CHECK_FIFO_OVERRUN(x)	(((x) >> 3) & 0x1)
...
struct adxl362_data {
	...
	sensor_trigger_handler_t fifo_handler;
	const struct sensor_trigger *fifo_trigger;
